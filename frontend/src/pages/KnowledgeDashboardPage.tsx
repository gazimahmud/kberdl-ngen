...
const PROJECTS: ProjectData[] = [
  {
    ...
    notebooks: [
      { step: "01", name: "database_exploration.ipynb", purpose: "Full inventory of the SQLite database — tables, schemas, NULL coverage, distributions" },
      { step: "02", name: "berdl_connection_scan.ipynb", purpose: "BERDL connection validation via Spark queries across 5 identifier types" },
      { step: "03", name: "cluster_id_mapping.ipynb", purpose: "Pangenome cluster ID bridge construction (mmseqs2 ↔ BERDL centroid IDs)" },
      { step: "04", name: "gene_essentiality_and_fitness.ipynb", purpose: "Multi-omics: essentiality, FBA concordance, fitness distributions, proteomics" },
      { step: "05", name: "metabolic_model_and_phenotypes.ipynb", purpose: "Metabolic model analysis: gapfilling, reaction conservation, growth predictions" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "data_extraction.ipynb", purpose: "Extract ADP1 growth matrix and annotation data from SQLite database" },
      { step: "02", name: "condition_structure.ipynb", purpose: "PCA, correlation analysis, and dimensionality of the 8-condition phenotype space" },
      { step: "03", name: "gene_modules.ipynb", purpose: "Hierarchical clustering and ICA to identify co-defective gene modules" },
      { step: "04", name: "condition_specific.ipynb", purpose: "Identify and characterize genes with condition-specific growth defects" },
      { step: "05", name: "tnseq_gap.ipynb", purpose: "Profile genes with TnSeq classifications but no deletion mutant data" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "data_integration.ipynb", purpose: "Integrate TnSeq, FBA, and growth data; build triple-covered gene set" },
      { step: "02", name: "concordance_analysis.ipynb", purpose: "Statistical tests of FBA vs growth concordance across conditions" },
      { step: "03", name: "discordance_characterization.ipynb", purpose: "Profile discordant genes by function, pangenome status, and annotation" },
      { step: "04", name: "pangenome_context.ipynb", purpose: "Map discordance patterns onto pangenome conservation and COG categories" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "amr_landscape.ipynb", purpose: "AMR gene prevalence, conservation, and pangenome distribution overview" },
      { step: "02", name: "phylogenetic_distribution.ipynb", purpose: "AMR density by phylum, lineage hotspots, and pangenome openness correlation" },
      { step: "03", name: "mechanism_analysis.ipynb", purpose: "Resistance mechanism classification, COG co-occurrence, defense islands" },
      { step: "04", name: "environmental_signal.ipynb", purpose: "AlphaEarth stratification of AMR profiles by isolation environment" },
      { step: "05", name: "annotation_depth.ipynb", purpose: "AMR-only dark matter identification and functional characterization" },
      { step: "06", name: "fitness_cost.ipynb", purpose: "AMR gene fitness effects in standard lab conditions via Fitness Browser" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "quinate_genes_characterization.ipynb", purpose: "Characterize the 51 quinate-specific genes by function and pathway" },
      { step: "02", name: "fba_carbon_source_scan.ipynb", purpose: "FBA flux predictions across 230 carbon sources to test NADH hypothesis" },
      { step: "03", name: "cofitness_network.ipynb", purpose: "Co-fitness network analysis and module identification" },
      { step: "04", name: "cross_species_validation.ipynb", purpose: "Fitness Browser validation across organisms with aromatic catabolism" },
      { step: "05", name: "genomic_organization.ipynb", purpose: "Chromosomal organization, regulatory co-localization, and operon structure" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "bacdive_bridge.ipynb", purpose: "Link BacDive genome accessions to K-BERDL pangenome species" },
      { step: "02", name: "environment_scoring.ipynb", purpose: "Score isolation environments and test association with metal tolerance" },
      { step: "03", name: "phylogenetic_control.ipynb", purpose: "Stratify results by phylum to test phylogenetic confounding" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "phenotype_extraction.ipynb", purpose: "Extract BacDive phenotype features and link to pangenome species" },
      { step: "02", name: "univariate_analysis.ipynb", purpose: "Univariate tests of phenotype-metal tolerance associations" },
      { step: "03", name: "multivariate_model.ipynb", purpose: "Regression models with and without phylogenetic covariates" },
      { step: "04", name: "genome_vs_phenotype.ipynb", purpose: "Compare phenotypic vs genomic predictors of metal tolerance" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "cooccurrence_matrix.ipynb", purpose: "Build pangenome co-occurrence phi coefficient matrices per species" },
      { step: "02", name: "pairwise_cofitness.ipynb", purpose: "Test pairwise co-fitness vs co-occurrence across 9 organisms" },
      { step: "03", name: "phylogenetic_control.ipynb", purpose: "Phylogenetic controls and operon co-localization analysis" },
      { step: "04", name: "module_coinheritance.ipynb", purpose: "ICA module co-inheritance analysis — core vs accessory modules" },
      { step: "05", name: "functional_enrichment.ipynb", purpose: "Functional characterization of significantly co-inherited modules" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "cog_extraction.ipynb", purpose: "Extract COG annotations and gene conservation classes from BERDL" },
      { step: "02", name: "distribution_analysis.ipynb", purpose: "COG category distributions by core/auxiliary/novel across 32 species" },
      { step: "03", name: "cross_phylum_analysis.ipynb", purpose: "Test universality of pattern across 9 bacterial phyla" },
    ],
    figures: [],
  },
  {
    ...
    notebooks: [
      { step: "01", name: "fitness_conservation_bridge.ipynb", purpose: "Link Fitness Browser genes to pangenome clusters via DIAMOND blastp" },
      { step: "02", name: "gradient_analysis.ipynb", purpose: "Quantify fitness-conservation gradient across conservation categories" },
      { step: "03", name: "burden_paradox.ipynb", purpose: "Dissect the core gene burden paradox by function and condition" },
      { step: "04", name: "selection_signatures.ipynb", purpose: "Construct selection-signature matrix identifying 28K purifying selection genes" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "diamond_mapping.ipynb", purpose: "DIAMOND blastp mapping of 221K FB genes to 132M pangenome clusters" },
      { step: "02", name: "essentiality_calling.ipynb", purpose: "Define putative essential genes from RB-TnSeq insertion density" },
      { step: "03", name: "conservation_enrichment.ipynb", purpose: "Forest plot meta-analysis of essential gene core enrichment across 33 organisms" },
      { step: "04", name: "functional_profiles.ipynb", purpose: "Characterize essential-core vs essential-auxiliary by SEED/COG/enzyme content" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "burden_by_function.ipynb", purpose: "Dissect the burden paradox by COG/SEED function categories" },
      { step: "02", name: "tradeoff_identification.ipynb", purpose: "Identify trade-off genes (important in some conditions, costly in others)" },
      { step: "03", name: "condition_analysis.ipynb", purpose: "Condition-specific burden analysis across growth environments" },
      { step: "04", name: "selection_signatures.ipynb", purpose: "Construct 28K purifying-selection gene set from fitness-conservation matrix" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "gene_set_definition.ipynb", purpose: "Extract 5,526 costly+dispensable genes from selection-signature matrix" },
      { step: "02", name: "annotation_enrichment.ipynb", purpose: "SEED and KEGG annotation enrichment analysis vs genome background" },
      { step: "03", name: "ortholog_breadth.ipynb", purpose: "Taxonomic breadth analysis using orthogroup membership across 48 organisms" },
      { step: "04", name: "gene_characteristics.ipynb", purpose: "Gene length, GC content, and per-organism distribution analysis" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "experiment_classification.ipynb", purpose: "Classify Fitness Browser experiments by metal type and counter ion" },
      { step: "02", name: "nacl_overlap.ipynb", purpose: "Quantify overlap between metal-important and NaCl-stress gene sets" },
      { step: "03", name: "correction_analysis.ipynb", purpose: "Rerun Metal Atlas conclusions after removing NaCl-shared genes" },
      { step: "04", name: "zinc_sulfate_validation.ipynb", purpose: "Validate conclusions using zero-chloride zinc sulfate experiments" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "embedding_analysis.ipynb", purpose: "Process AlphaEarth environmental embeddings for pangenome genomes" },
      { step: "02", name: "gene_content_matrix.ipynb", purpose: "Build pairwise gene content similarity matrices for 172 species" },
      { step: "03", name: "partial_correlation.ipynb", purpose: "Compute partial correlations controlling for phylogeny vs environment" },
      { step: "04", name: "cross_phylum_analysis.ipynb", purpose: "Test consistency of environment vs phylogeny signal across phyla" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "sample_classification.ipynb", purpose: "Classify genomes as environmental vs host-associated using isolation metadata" },
      { step: "02", name: "embedding_quality.ipynb", purpose: "Quantify geographic signal strength in environmental vs clinical embeddings" },
      { step: "03", name: "restricted_analysis.ipynb", purpose: "Rerun ecotype partial correlation analysis with environmental samples only" },
      { step: "04", name: "comparison.ipynb", purpose: "Compare restricted vs full analysis results — test for clinical bias effect" },
    ],
  ...
  },
  {
    ...
    notebooks: [
      { step: "01", name: "enigma_extraction.ipynb", purpose: "Extract ENIGMA geochemistry, community counts, and taxonomy from CORAL" },
      { step: "02", name: "contamination_index.ipynb", purpose: "Build uranium + co-metal contamination indices per sample" },
      { step: "03", name: "taxonomy_bridge.ipynb", purpose: "Map ENIGMA genera to BERDL pangenome clades for functional inference" },
      { step: "04", name: "functional_aggregation.ipynb", purpose: "Aggregate COG defense/mobilome functional potential per sample" },
      { step: "05", name: "statistical_tests.ipynb", purpose: "Confirmatory and exploratory association tests with bootstrap CI and FDR" },
    ],
            ...
            <div key={nb.step} className="kd-pipeline-step">
              ...
              <div className="kd-step-body">
                <div className="kd-step-name">
                  <i className="fa-solid fa-file-code kd-nb-icon" /> {nb.name}
                </div>
